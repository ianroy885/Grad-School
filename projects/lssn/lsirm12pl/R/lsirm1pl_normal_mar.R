...
#'
#' @description \link{lsirm1pl_normal_mar} is used to fit LSIRM for continuous variable with 1pl in incomplete data assumed to be missing at random.
...
#'
#' @return \code{lsirm1pl_normal_mar} returns an object of  list containing the following components:
