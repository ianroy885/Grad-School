...
#'
#' @description \link{lsirm2pl_mar} is used to fit 2PL LSIRM in incomplete data assumed to be missing at random.
...
lsirm2pl_mar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_mar_cpp(data=as.matrix(data), ndim=ndim, niter=niter, nburn=nburn, nthin=nthin, nprint=nprint,
