...
#'
#' @description \link{lsirm2pl_mcar} is used to fit 2PL LSIRM in incomplete data assumed to be missing completely at random.
...
lsirm2pl_mcar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_mcar_cpp(data=as.matrix(data), ndim=ndim, niter=niter, nburn=nburn, nthin=nthin, nprint=nprint,
