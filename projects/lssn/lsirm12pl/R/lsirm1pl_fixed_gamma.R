...
#'
#' @description \link{lsirm1pl_fixed_gamma} is used to fit 1PL LSIRM with gamma fixed to 1.
#' \link{lsirm1pl_fixed_gamma} factorizes item response matrix into column-wise item effect, row-wise respondent effect and further embeds interaction effect in a latent space. The resulting latent space provides an interaction map that represents interactions between respondents and items.
#'
