...
#'
#' @description \link{lsirm2pl_normal_o} is used to fit 2PL LSIRM for continuous variable.
...
#'
#' @return \code{lsirm2pl_normal_o} returns an object of  list containing the following components:
