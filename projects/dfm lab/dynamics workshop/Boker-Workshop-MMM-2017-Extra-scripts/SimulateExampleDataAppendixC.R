# ---------------------------------------------------------------------
# Program: SimulateExampleDataAppendixC.R
#  Author: Steve Boker
#    Date: Wed Jan 27 13:58:31 EST 2016
#
# This program simulates individual differences in equilibrium intercept and slope. 
#
# ---------------------------------------------------------------------
...
pdf("ExampleDataAppendixC.pdf", height=5, width=6)
plot(c(1, P), c(-10, 10),
     xlab="Sample Index",
     ylab="Score",
     type='n')
...
write.csv(simDataFrame, file="ExampleDataAppendixC.csv", row.names=FALSE)
