# ---------------------------------------------------------------------
# Program: SimulateExampleDataAppendixD.R
#  Author: Steve Boker
#    Date: Wed Jan 27 13:58:38 EST 2016
#
# This program simulates individual differences in equilibrium level and slope
#   with second level predictors of frequency and damping. 
#
# ---------------------------------------------------------------------
...
for(tID in 1:N) {
    ...
    randSlope <-  rnorm(1, mean=0, sd=sdSlope)
...
write.csv(simDataFrame, file="ExampleDataAppendixD.csv", row.names=FALSE)
